...
class _LoginPage extends State<LoginPage> {
  ...
  Future getMemopolUser() async {
    Uri url = Uri.parse(pathPHP + "readPONTABACUSERS.php");
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        QuizzCommons.myUid = listMemopolUsers[0].uid;
        QuizzCommons.myPseudo = listMemopolUsers[0].uname;
        QuizzCommons.myProfile = listMemopolUsers[0].uprofile;
  ...
  startLogin() async {
    Uri url = Uri.parse(pathPHP + "checkPONTABACUSERS.php");
    var data = {"UNAME": username, "UPASS": password};
    http.Response response = await http.post(url, body: data);
    if (response.statusCode == 200) {
